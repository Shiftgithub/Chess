...
class Tile:
    def __init__(self, master, row, column):
        ...
        self.column = column
        self.tile_text = ''
        self.label = Label(master, height=int(
            Tile.rect_length / 2), width=Tile.rect_length, borderwidth=2, relief="solid")
    ...
    chosen_tile = None
    tile_list = []
    # this variable will store the coor of the piece the player wants to move
    inp = ['', '']
    ...
    def press_tile(self, event):
        ...
        if self.label['background'] == 'green':
            ...
            is_game_over = logic.game_turn(
                logic.turn, Tile.inp, outp)  # input and output
            ...
            for move in current_piece.current_potential_moves:
                ...
                for tile in Tile.tile_list:
                    if tile.row == move_row and tile.column == move_column:
                        ...
                        logic.Piece.set_all_current_potential_moves(
                            logic.Piece, logic.turn)
